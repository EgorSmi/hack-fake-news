...
from parser import MosRuParser, RiaRuParser

N_THREADS = 10

def main(mos_ru_pages: str, ria_pages: str):
    ...
    parse_perform = ((mos_ru_parser, mos_ru_urls), (ria_parser, ria_urls))
...
if __name__ == "__main__":
    ...
    main(mos_ru_pages=args.mos_ru_pages, ria_pages=args.ria_pages)
